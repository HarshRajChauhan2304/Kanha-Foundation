      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-stretch mb-12">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-6">
            ...
            {/* Address box */}
            <div className="bg-white dark:bg-[#101412] p-8 rounded-[2rem] border border-gray-150/45 dark:border-zinc-800/80 shadow-sm flex items-start gap-4 text-left">
              ...
              <div>
                <h3 className="text-sm font-extrabold text-gray-900 dark:text-white uppercase tracking-wider">Registered Address</h3>
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 leading-relaxed font-bold">
                  Kanha Foundation Office,<br />
            ...
            <div className="bg-white dark:bg-[#101412] p-8 rounded-[2rem] border border-gray-150/45 dark:border-zinc-800/80 shadow-sm flex items-start gap-4 text-left">
              ...
              <div>
                <h3 className="text-sm font-extrabold text-gray-900 dark:text-white uppercase tracking-wider">Email Inquiry</h3>
                <p className="mt-2 text-sm text-[#1E4D2B] dark:text-[#52c47c] font-black hover:underline cursor-pointer">
                  support@kanhafoundation.org
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#101412] p-8 rounded-[2rem] border border-gray-150/45 dark:border-zinc-800/80 shadow-sm flex items-start gap-4 text-left">
              ...
              <div>
                <h3 className="text-sm font-extrabold text-gray-900 dark:text-white uppercase tracking-wider">WhatsApp Support</h3>
                <p className="mt-2 text-sm text-[#1E4D2B] dark:text-[#52c47c] font-black hover:underline cursor-pointer" onClick={() => window.open("https://wa.me/917488164529", "_blank")}>
                  +91 74881 64529
                </p>
              </div>
            </div>
